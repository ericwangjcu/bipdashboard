            ...
            <div class="offcanvas offcanvas-end" tabindex="-1" id="offcanvasExample" aria-labelledby="offcanvasExampleLabel">
                ...
                <script>
                    ...
                    for (let i=0;i<irrigfield.length;i++){
                        ...
                        for (let j=0;j<setvalues.length;j++){
                            if (setvalues[j][19] == irrigfield[i][0]){
                                ...
                                // updateirrigation("2021-09-10", farminfor[0] + setinfor[0]);
                                // testcolumnchart(farminfor[0] + setinfor[0] + "chart");
                    ...
                    (function(i) {
                        ...
                        updateirrigation("2021-09-10", i.id.substring(0, 6),i.id.substring(6, 10));  
